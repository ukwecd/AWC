...
const ProjectPassbookFinancial202223 = () => {
        ...
        <div className="main-container">
          ...
          <div className="main">
            <div className="awc-dpo-head">
              <h1>Project Passbook Financial Year 2022-23</h1>
            </div>
                ...
                <Table className="awc-sub-table" striped bordered hover>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>UK321</td>
                      <td>15</td>
                      <td>AWC Rent | आंगनवाड़ी भवन किराया</td>
                      <td>
                        <div className="dpo-p">
...
export default ProjectPassbookFinancial202223;
