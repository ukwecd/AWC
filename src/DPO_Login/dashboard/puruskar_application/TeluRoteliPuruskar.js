        ...
        <div className="main-container">
          ...
          <div className="main">
            <div className="awc-dpo-head">
              <h1>Rajya Stree Shakti Telu Roteli Puruskar Applicant List 2023-24</h1>
            </div>
                ...
                <Accordion defaultActiveKey="0">
                  <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                     ...
                     <p>Click on the form ID to view Detailed Profile or Approve and Disapprove</p> 
                      </div>
                      <Row>
                        ...
                        <Table className="awc-sub-table" striped bordered hover>
                          ...
                          <Button className="dpo-form-id-btn">
                            <span className="badge  rounded-pill text-dark-white d-inline-block nd-btn-district nd-btn-district1">
                              <FaIdCard className="awc-dpo-add-icon" /> TR-2024-0010
                            </span>
                          </Button>
                        </div>
                            </td>
