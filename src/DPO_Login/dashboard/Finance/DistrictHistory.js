    ...
    <>
      ...
      <Modal show={show} onHide={handleClose} size="lg">
        <Modal.Header closeButton>
          <Modal.Title className="awc-buget-heading">History Of Buget alloment to Almora (ta 15) FIN/2023-24</Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default DistrictHistory;
