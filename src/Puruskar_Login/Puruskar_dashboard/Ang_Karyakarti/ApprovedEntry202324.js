      ...
      <div>
        ...
        <div className="main-container">
          ...
          <div className="awc-dpo-head">
              <h1>Anganwadi Purskar Selected by District Section Committee List 2022-23</h1>
            </div>
            <Row>
            ...
            <div className="awc-dpo-head">
              <h1>AWW Award 2022-23: All Selected For Purskar</h1>
            </div>
            <Row>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <div className="dpo-p">
                            <Link to="#">
                              ...
                              <Button className="awc-btn-money text-primary">
                                <span className="badge  rounded-pill text-primary d-inline-block nd-btn-district-btnn nd-btn-district1">
                                <FaIdCard className="awc-dpo-add-icon" />  AP-2024-00079 
                                </span>
                              </Button>
                            </Link>
                          </div>
                       ...
                       <td>93</td>
                        ...
                        <div className="dpo-p">
                          <Button className="dpo-approved-btn">
                            <span className="badge  rounded-pill text-dark-white d-inline-block nd-btn-district nd-btn-district1">
                              <IoIosCheckmarkCircle className="awc-dpo-add-icon" /> Submit
                            </span>
                          </Button>
                        </div>
                      </td>
                        ...
                        <tr>
                          ...
                          <div className="dpo-p">
                            <Link to="#">
                              ...
                              <Button className="awc-btn-money text-primary">
                                <span className="badge  rounded-pill text-primary d-inline-block nd-btn-district-btnn nd-btn-district1">
                                <FaIdCard className="awc-dpo-add-icon" />  AP-2024-000120
                                </span>
                              </Button>
                            </Link>
                          </div>
