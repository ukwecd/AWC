        ...
        <div className="main-container">
          ...
          <div className="main">
            ...
            <div className="awc-dpo-head">
              <h1>State Protsahan Excel Generation</h1>
            </div>
            ...
            <div className="awc-after-fillter mt-3">
              ...
              <Row><h2>ALMORA Employee Pending Protsahan 2021-22 Manday list(0-1268)</h2>
...
export default GenerateProtsahanExcel;
