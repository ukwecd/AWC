          ...
          <div className="main">
                  ...
                  <Row>
                    ...
                    <Col lg={12} md={12} sm={12} >
                      ...
                      <Row className="awc-bills-box1">
                        <div className="awc-label-title">Report for:</div>
                        <Col lg={3} md={3} sm={3}>
                          <Form.Group
                            className=" "
            ...
            <div className="awc-after-fillter mt-3">
              ...
              <Row className="d-flex justify-content-between">
                <Col lg={9} md={9} sm={12}><h2>Manday Report(With Kalyan-Kosh) for Month : April 2023-24</h2></Col>
                <Col lg={3} md={3} sm={12} className="aws-top-btn"> <Button variant="secondary" className="aws-grant-btn mx-3">
                ...
                <Table className="awc-sub-table" striped bordered hover>
                  <thead className="Direct-thead th">
                    <tr>
                      ...
                      <th>MINI</th>
                      <th>Worker Total</th>
                      <th>Worker(State Manday not "0")</th>
                      <th>Kalyankosh Amount</th>
                      <th>Total Honararium</th>
...
export default KalyankoshReport;
