        ...
        <div className="main-container">
          ...
          <div className="main">
            ...
            <div className="awc-dpo-head">
              <h1>Center Honorarium Generation</h1>
            </div>
            ...
            <div className="box-container awc-after-fillter">
              ...
              <div>
                <h2 className="pt-2">District - ALMORA Employee | Grant - All | Month - February 2024-25</h2>
            ...
            <div className="awc-after-fillter mt-3">
              ...
              <Row><h2>February 2024-25 Manday list(0-2849)</h2>
...
export default CenterMandayPFMSFormat;
